  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-6">
      <header className="mb-12">
        <h1 className="text-5xl font-black text-slate-900 tracking-tight capitalize">Hebrew Section</h1>
        <p className="text-slate-500 mt-4 text-xl font-medium">Enhance your reading comprehension and verbal reasoning.</p>
      </header>
